...
nametotype_df = pd.read_csv(nametotype_path, sep='\t', header=None, names=['name', 'type'])

nametotype_df['res1'] = nametotype_df['name'].str.slice(0, 1)

nametotype_df_grouped = nametotype_df.groupby("res1")

for res1, type in nametotype_df_grouped:
    print(res1)
    print(type)
